...
public class GameMap {
    ...
    public void initNodetoNode() {
        ...
        nodeNeighbors[52] = new int[]{51, 53, 9};
        ...
        nodeNeighbors[9]  = new int[]{18,  8, 52,  2};
        nodeNeighbors[53] = new int[]{52, 2};
        nodeNeighbors[32] = new int[]{33, 31, 10};
        nodeNeighbors[10] = new int[]{ 6, 32,  0,  3};
     ...
     */
    public void distributeResources(int diceRoll, Agent[] agents) {
